      ...
      <div className="bg-[#131b2e] border border-[#243252] p-6 rounded-xl space-y-4">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 mt-1">Execute automated connection, throughput, and CRC packet integrity tests</p>
          </div>
          <button
            onClick={runDiagnostics}
            disabled={running}
            className="flex items-center space-x-2 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-400 hover:to-yellow-500 text-black font-bold px-5 py-2.5 rounded-lg shadow-md disabled:opacity-50"
          >
      ...
      {results && (
        <div className="bg-[#131b2e] border border-[#243252] p-6 rounded-xl space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#0d1322] p-4 rounded-lg border border-[#243252] flex justify-between items-center">
